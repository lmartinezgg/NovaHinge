...
#[derive(Debug)]
pub struct NovaHingeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NovaHingeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NovaHinge processing");
    
    let mut processor = NovaHingeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NovaHingeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NovaHingeProcessor::new(false);
